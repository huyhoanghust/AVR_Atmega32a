...
void move_LCD(uint8_t ,uint8_t);//di chuyen cursor (dong, cot)
void clr_LCD();			//clear LCD
void putChar_LCD(uint8_t);//hien thi 1 ki tu
void print_LCD(uint8_t*); //hien thi 1 chuoi ki tu
void number_LCD(uint16_t);//hien thi 1 so
...
void print_LCD(uint8_t* str){ //Hi?n th? 1 chu?i ký t?
	 unsigned int i;
 ...
 void number_LCD(uint16_t number){
